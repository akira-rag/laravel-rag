...
## [0.2.0](https://github.com/akira-rag/laravel-rag/compare/v0.1.0...v0.2.0) (2025-12-20)

### Features

* add custom exception classes for cache, chunking, configuration, database, document, embedding, export, import, invalid question, retrieval, and tenant resolution errors ([174d77d](https://github.com/akira-rag/laravel-rag/commit/174d77dcc88e40e6335f73627dbee5dd0007642b))
* enhance InvalidPayload with detailed error handling and add TenantResolverException for improved validation ([0d3d605](https://github.com/akira-rag/laravel-rag/commit/0d3d605b83e4ecbb0ace2b648c4f87108ef99fa6))

### Bug Fixes

* add composer.lock to .gitignore ([7144c58](https://github.com/akira-rag/laravel-rag/commit/7144c58f7fffe8c5a0729efee0b07b5bb3ca035f))

### Documentation

* enhance ingestion and installation guides with detailed usage examples and configuration options ([25e5098](https://github.com/akira-rag/laravel-rag/commit/25e5098a0c24abed203dd4b7cee135cb32cc8df6))
* update README with enhanced features, installation instructions, and usage examples ([e26ed4c](https://github.com/akira-rag/laravel-rag/commit/e26ed4c16a44ddbd1f5d64cd32a64ddddfa30a59))

### Code Refactoring

* improve variable naming for clarity in command classes ([fc7b16b](https://github.com/akira-rag/laravel-rag/commit/fc7b16bc7ac22c0ae817bcd260f15fc4bd876b73))
## 0.1.0 (2025-12-19)
